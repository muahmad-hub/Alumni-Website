...
# Opens the initial message webpage
# 'current_chat' set to False so that initially no chat is open, 'Pick a conversation' message is displayed
@login_required
...
# Opens the specific chat with a user
# If the other user is the mentor then the is_mentor variable is set to True to display Mentor tag on the chat
@login_required
...
# Returns data for the contact list
# Retreives data from the search bar and filters through users contact list by name of their contact
